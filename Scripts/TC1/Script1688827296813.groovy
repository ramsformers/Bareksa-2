...
Mobile.tap(findTestObject('Object Repository/Login/android.widget.EditText - Contoh emailgmail.com'), 0)

Mobile.tap(findTestObject('Object Repository/Login/android.widget.EditText - Masukkan Password'), 0)
